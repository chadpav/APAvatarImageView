#
# Be sure to run `pod lib lint APAvatarImageView.podspec' to ensure this is a
...
APAvatartImageView is a subclass on UIImageView. It will render a placeholder avatar image using a users initials. The default style looks like the iOS 10 iMessage avatar image.
  ...
  s.source_files = 'APAvatarImageView/Classes/**/*'
  
  # s.resource_bundles = {
  #   'APAvatarImageView' => ['APAvatarImageView/Assets/*.png']
  # }
